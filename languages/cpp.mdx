...
tutorial::AddressBook* address_book =
    google::protobuf::Arena::CreateMessage<tutorial::AddressBook>(&arena);
...
<CardGroup cols={2}>
  ...
  <Card title="Arena" icon="memory">
    `google::protobuf::Arena` — arena allocator. Use `Arena::CreateMessage<T>(&arena)` to allocate messages on the arena.
  </Card>
